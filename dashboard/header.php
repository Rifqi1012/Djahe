...
<head>
  ...
  <style>
    ...
    .keranjang-container:hover {
      color: #B38E50;
    }

    .keranjang-container i,
    .keranjang-container .keranjang-text {
      color: inherit;
    }
  </style>
...
<body>
  <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #FFF8F4; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
    <div class="container">
      <a class="navbar-brand" href="#">
        <img src="assets/image/SireheLogo.png" alt="" width="150" class="mb-1">
      </a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ml-auto">
          ...
          <?php if ($level == "Admin") : ?>
            <a class="nav-link nav-item <?= $dash ?>" href="index.php?dashboard" style="color: #000">Dashboard <span class="sr-only">(current)</span></a>
            <div class="nav-item dropdown <?= $us ?><?= $m ?>">
              <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" role="button" data-toggle="dropdown" style="color: #000">Kelola Data</a>
              <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                <a class="dropdown-item" href="index.php?user" style="color: #000">Data User</a>
                <a class="dropdown-item" href="index.php?makanan" style="color: #000">Data Makanan</a>
              </div>
            </div>
            <a class="nav-link nav-item <?= $or ?>" href="index.php?order" style="color: #000">Data Pesanan<span class="sr-only">(current)</span></a>
            <a class="nav-link nav-item <?= $tran ?>" href="index.php?transaksi" style="color: #000">Data Transaksi <span class="sr-only">(current)</span></a>
            <a class="nav-link nav-item <?= $lap ?>" href="index.php?laporan" style="color: #000">Laporan <span class="sr-only">(current)</span></a>

          <?php elseif ($level == "Pelayan") : ?>
            <a class="nav-link nav-item <?= $beranda ?>" href="index.php?beranda" style="color: #000">Beranda <span class="sr-only">(current)</span></a>
            <a class="nav-link nav-item <?= $daftarmeja ?>" href="index.php?daftarmeja" style="color: #000">Daftar Meja <span class="sr-only">(current)</span></a>
            <a class="nav-link nav-item <?= $home ?>" href="index.php" style="color: #000">Home <span class="sr-only">(current)</span></a>
            <a class="nav-link nav-item <?= $or ?>" href="index.php?order" style="color: #000">Data Pesanan <span class="sr-only">(current)</span></a>
            <a class="nav-link nav-item <?= $lap ?>" href="index.php?laporan" style="color: #000">Laporan <span class="sr-only">(current)</span></a>

          <?php elseif ($level == "Kasir") : ?>
            <a class="nav-link nav-item <?= $beranda ?>" href="index.php?beranda" style="color: #000">Home <span class="sr-only">(current)</span></a>
            <a class="nav-link nav-item <?= $tran ?>" href="index.php?transaksi" style="color: #000">Data Transaksi <span class="sr-only">(current)</span></a>
            <a class="nav-link nav-item <?= $lap ?>" href="index.php?laporan" style="color: #000">Laporan <span class="sr-only">(current)</span></a>

          <?php elseif ($level == "Gudang") : ?>
            <a class="nav-link nav-item <?= $beranda ?>" href="index.php?beranda" style="color: #000">Home <span class="sr-only">(current)</span></a>
            <a class="nav-link nav-item <?= $m ?>" href="index.php?makanan" style="color: #000">Data Menu <span class="sr-only">(current)</span></a>
      </div>
    ...
    <ul class="navbar-nav ml-auto">
      <?php if ($_SESSION['level'] == "") : ?>
        <a href="../auth/index.php" class="btn" style="background-color: #B38E50; color: #fff;">Login</a>

      <?php else : ?>
        <li class="nav-item dropdown">
          <a href="#" class="nav-link dropdown-toggle" style="color: #000;" data-toggle="dropdown" role="button"><i class="fa fa-user mr-1"></i><?= $_SESSION['level'] ?><span class="mr-1"></span></a>
      ...
      <?php if ($_SESSION['level'] == "Pelayan") : ?>
        <li class="nav-item dropdown">
          <a class="nav-link" data-toggle="modal" data-target=".bd-example-modal-xl">
            <span class="keranjang-container">
              <i class="fa fa-shopping-cart mr-1"></i>
              <span class="keranjang-text">Keranjang</span>
            </span>
          </a>
