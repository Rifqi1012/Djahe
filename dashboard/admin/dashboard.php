...
<div style="background-color: #FFF8F4; min-height: 100vh; padding: 20px; display: flex; justify-content: center;">
	...
	<div class="container mt-3">
		...
		<div class="row">
			<div class="col-4">
				<div class="card shadow-lg" style="height: 407px; background-color:#FFF8F4">
					<center>
			...
			<div class="col-8">
				<div class="row ">
					<div class="col">
						<div class="card shadow-lg mb-3" style="background-color: #FFF8F4;">
							<div class="row">
								<div class="col-md-3">
				...
				<div class="row">
					<div class="col">
						<div class="card shadow-lg mb-3 d-flex align-items-center" style="background-color: #FFF8F4">
							<div class="row">
								<div class="col-md-2">
